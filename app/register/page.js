    ...
    <div className="fixed inset-0 bg-paper flex items-center justify-center p-6 overflow-y-auto">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl border border-sand p-8 shadow-sm">
          <h2 className="font-display text-2xl font-bold text-ink mb-1">Create an account</h2>
          <p className="font-ui text-sm text-ink mb-7">Start planning your trips for free</p>
